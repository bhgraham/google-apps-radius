 ...
 */
var authenticate;
module.exports.authenticate = authenticate = function(username, password, domains, options, callback) {
    if (!callback) {
        callback = options;
        options = {};
    }
    ...
    if (!domains.includes(p[1])) {
        callback("Invalid Domain");
        return;
    }
...
module.exports.createServer = function(options) {
    ...
    server.on('message', function(msg, rinfo) {
        ...
        // Reply function
        authenticate(username, password, options.domains, function(err, obj) {
